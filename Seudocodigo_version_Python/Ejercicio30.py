...
'''
if dinero == 5:
    print("Tendras un billete de 5")
elif dinero == 10:
    print("tendras un billete de 10")
elif dinero == 15:
    print("tendras un billete de 10 y otro de 5")
elif dinero == 20:
    print("tendras un billete de 20")
elif dinero <= 25 or dinero >= 50:
    if dinero / 20:
      numero_de_billetes_de_20 = dinero % 20
      dinero =  dinero - (20 * numero_de_billetes_de_20) 
    if dinero / 5:
        numero_de_billetes_de_5 = dinero % 5
        dinero = dinero - (5 * numero_de_billetes_de_5) 
'''
